...
PROGRAM_ORACLE_ID="${VITE_FIGHT_ORACLE_PROGRAM_ID:-EW9GwxawnPEHA4eFgqd2oq9t55gSG4ReNqPRyG6Ui6PF}"
PROGRAM_MARKET_ID="${VITE_GOLD_BINARY_MARKET_PROGRAM_ID:-23YJWaC8AhEufH8eYdPMAouyWEgJ5MQWyvz3z8akTtR6}"

...
const views = [
  { name: 'fresh-desktop', width: 1440, height: 900 },
  { name: 'fresh-tablet-portrait', width: 768, height: 1024 },
  { name: 'fresh-mobile', width: 390, height: 844 },
];
...
await browser.close();
console.log('saved fresh screenshots');

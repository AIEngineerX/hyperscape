...
$$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_player_combat_stats_updated_at" ON "player_combat_stats" USING btree ("updatedAt");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_player_combat_stats_kills" ON "player_combat_stats" USING btree ("totalPlayerKills");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_player_combat_stats_deaths" ON "player_combat_stats" USING btree ("totalDeaths");
--> statement-breakpoint
...
$$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_combat_stat_events_type" ON "combat_stat_events" USING btree ("eventType");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_combat_stat_events_player" ON "combat_stat_events" USING btree ("playerId");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_combat_stat_events_secondary" ON "combat_stat_events" USING btree ("secondaryPlayerId");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_combat_stat_events_duel" ON "combat_stat_events" USING btree ("duelId");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_combat_stat_events_created" ON "combat_stat_events" USING btree ("createdAt");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "uidx_onchain_outbox_dedupe" ON "onchain_outbox" USING btree ("dedupeKey");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_onchain_outbox_status_next_attempt" ON "onchain_outbox" USING btree ("status","nextAttemptAt");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_onchain_outbox_locked_at" ON "onchain_outbox" USING btree ("lockedAt");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_onchain_outbox_stream" ON "onchain_outbox" USING btree ("stream");

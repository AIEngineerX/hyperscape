...
ALTER TABLE "duel_settlements" ADD CONSTRAINT "duel_settlements_winnerId_characters_id_fk" FOREIGN KEY ("winnerId") REFERENCES "public"."characters"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "duel_settlements" ADD CONSTRAINT "duel_settlements_loserId_characters_id_fk" FOREIGN KEY ("loserId") REFERENCES "public"."characters"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
